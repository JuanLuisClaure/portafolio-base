...
<compra>
        ...
        <div id="slideshow" class="slideshow" style="height: 92vh;margin:0 0 0 0;display: grid;">
            <div class="slide">
                <h2 class="slide__title slide__title--preview">Macadamia Skin Oil <span class="slide__price">$39</span></h2>
                <div class="slide__item">
                    <div class="slide__inner">
                        <img class="slide__img slide__img--small" src="./client/assets/img/6.png" alt="Some image" />
                        <button class="action action--open" aria-label="View details">*</button>
                    </div>
                </div>
                <div class="slide__content">
                    <div class="slide__content-scroller">
                        <img class="slide__img slide__img--large" src="./client/assets/img/36.png" alt="Some image" />
            ...
            <button class="action action--close" aria-label="Close">Ki</button>
    ...
    <script>
        ...
        this.on('mount', ()=>{
            // console.log('compra mountado', CircleSlideshow);
            document.documentElement.className = 'js';
            let slideshow = new CircleSlideshow(document.getElementById('slideshow'));
            // console.log('document.documentElement, ',slideshow)
        })
    </script>
</compra>