...
<comentario>
    <div style="display: grid;justify-content: center;align-content: center;">
        <!-- Colored FAB button -->
        <button class="mdl-button mdl-js-button mdl-button--fab mdl-button--colored" onclick='{ medisgusta }'>
            <i class="material-icons">add</i>
        </button>
    </div>
    <div style="display: grid;justify-content: left;align-content: baseline;">
        <div id="loaderco" style="display:none;background: black;height:11vh;width:17vw">
        ...
        <style>
            ...
            <ul style="margin:66% 0 0 -66%;list-style:none;">
                <li each={ info, i in cajon } >

             <div  id="{ i+'ec'}" class="demo-card-event mdl-card mdl-shadow--2dp" >
                 <div class="mdl-card__title mdl-card--expand" >
                    <div style="align-self: end; max-width: 17em; word-break: break-all;">
                        
                        <h5 style="background: rgb(27, 33, 71);padding:.92em .92em;width:auto;">{ info.tipome }</h5>
                        <h5 style="background: rgb(27, 33, 71);padding:.492em .5em;width:auto;">{ info.name }</h5>
                        
                                <ul style="display: flex;flex-direction: row;list-style: none;">
                                    <li each={ i in info.puntaje} class="estrellapuntaje">
                                        <!-- Icon button -->
                ...
                <div class="mdl-card__actions mdl-card--border" style="padding: 2.3em 3.2em;">
          
                <p>{ info.opinion }</p>
                <div>
                    <ul style="display: flex;flex-direction: row;list-style: none;position: absolute;bottom: 0;left: 0;">
                        <li class="estrellapuntajes">
                                <span class="mdl-badge" data-badge="24">
                                        <i class="material-icons" style="color:black;">mood</i>
                                    </span>
                        </li>
                        <li class="estrellapuntajes">
                                <span class="mdl-badge" data-badge="4">
                                        <i class="material-icons" style="color:black;">sentiment_neutral</i>
                                    </span>
                        </li>
                        <li class="estrellapuntajes">
                                <span class="mdl-badge" data-badge="34">
                                        <i class="material-icons" style="color:black;">mood_bad</i>
                                    </span>
                        </li>
                    </ul>
    ...
    <div style="display: grid;justify-content: center;align-content: center;">
        <!-- Colored FAB button -->
        <button class="mdl-button mdl-js-button mdl-button--fab mdl-button--colored" onclick='{ megusta }'>
            <i class="material-icons">add</i>
        </button>
    </div>
    <div style="display: grid;justify-content: center;align-content: center;" >
        <a href="" onclick='{ agregarmiopinion }'>
            opinar
        </a>
    ...
    <div style="display: grid;justify-content: center;align-content: center;">
        <!-- Colored FAB button -->
        <button class="mdl-button mdl-js-button mdl-button--fab mdl-button--colored" onclick='{ mevale }'>
            <i class="material-icons">add</i>
        </button>
    ...
    <div style="display: grid;justify-content: center;align-content: center;">
        <!-- Contact Chip -->
        <a href="" onclick='{ agregarmitestimonio }'>
            comentar
        </a>
...
//
// MUY LIMPIO 
// Primero introducir la informacion de lotes de A tres o diez
// Luego auntenticar la coneccion 
// las animaciones de los botones y los modales de los links
// dos formularios para agregar a la website y guardar en IndexDB
// Guardado mutiple tanto en pagina como en usuario indexdB
// 
//
//
//
